...
def main() -> None:
    ...
    if text != original:
        MAIN_PATH.with_suffix(".tsx.oc_skills.bak").write_text(original, encoding="utf-8")
        MAIN_PATH.write_text(text, encoding="utf-8")
        print("Patched frontend/src/main.tsx")
        print("Backup saved as frontend/src/main.tsx.oc_skills.bak")
    else:
    ...
    if "OC owned skills panel" not in css:
        CSS_PATH.with_suffix(".css.oc_skills.bak").write_text(css, encoding="utf-8")
