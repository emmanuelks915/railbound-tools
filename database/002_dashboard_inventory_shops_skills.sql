...
values
  (1462489358908129354, 'pilfer', 'Pilfer', 'Mercenary / Stealth', 0, 50, '[]'::jsonb, 'Pilfer → Stealth → Misdirection', 'Non-combat utility', 'Redirect attention, sleight of hand, pickpocketing, and planting.', 'Tier 0 stealth skill.', 'Skill Guide', 10),
  (1462489358908129354, 'stealth', 'Stealth', 'Mercenary / Stealth', 1, 265, '["pilfer"]'::jsonb, 'Pilfer → Stealth → Misdirection', 'Non-combat stealth', 'Hide, sneak, and set ambushes. Broken if detected or if attacking/defending once combat has begun.', 'Tier 1 stealth skill.', 'Skill Guide', 20),
  (1462489358908129354, 'misdirection', 'Misdirection', 'Mercenary / Stealth', 2, 475, '["stealth"]'::jsonb, 'Pilfer → Stealth → Misdirection', 'Combat stealth', 'Allows stealth actions in combat with AP costs and restrictions.', 'Tier 2 stealth skill.', 'Skill Guide', 30),
