...
def _delete_related_rows(sb, character_id: str) -> dict[str, int]:
    ...
    targets = [
        ...
        ("shop_items", "submitted_by_character_id"),
        ("shop_items", "created_by_character_id"),
        ("shop_items", "owner_character_id"),
        ("shops", "owner_character_id"),
        ("shop_orders", "character_id"),
        ("shop_orders", "buyer_character_id"),
        ("shop_purchases", "character_id"),
        ("shop_purchases", "buyer_character_id"),
